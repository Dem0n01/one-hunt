...
# 1. AUTH CONTROLLER - User Authentication
auth_controller = """const User = require('../models/User.model');
...
with open('auth.controller.js', 'w') as f:
    f.write(auth_controller)

print("✅ Created auth.controller.js")
