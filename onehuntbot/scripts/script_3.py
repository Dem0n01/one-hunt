...
transaction_controller = """const User = require('../models/User.model');
...
with open('transaction.controller.js', 'w') as f:
    f.write(transaction_controller)

print("✅ Created transaction.controller.js")
